CREATE DEFINER=`xxx`@`xxxx` PROCEDURE `checkAuth`(in p_userName varchar(500), in p_userTypeReq varchar(1), in p_userLevelReq varchar(1), p_software varchar(500))
BEGIN
	/*
	...
	*/
	...
	from xxxxxx where USERNAME = p_userName and SOFTWARE = p_software;
